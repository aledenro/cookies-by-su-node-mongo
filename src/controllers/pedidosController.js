...
const obtenerPedidos = async (req, res) => {
    try {
        const pedidos = await Pedido.find().populate("cliente_id").populate("productos.producto_id");
...
const obtenerPedidoPorId = async (req, res) => {
    try {
        ...
        const pedido = await Pedido.findById(id).populate("cliente_id").populate("productos.producto_id");
        if (!pedido) {
