    ...
    <div className="container mx-auto py-10 grid grid-cols-1 md:grid-cols-2 gap-6">
      <div className="bg-white shadow-lg rounded-lg p-6">
        ...
        <p className="text-gray-600 mb-6">
          Añade nuevos productos al inventario y mantén actualizado el catálogo
          de tu tienda.
        </p>
        <button
      ...
      <div className="bg-white shadow-lg rounded-lg p-6">
        <h2 className="text-xl font-lilita font-bold mb-4">
          Gestionar Usuarios
        </h2>
        <p className="text-gray-600 mb-6">
          Gestiona a los usuarios de tu negocio y organiza roles
          administrativos.
        </p>
        <button
          onClick={() => handleNavigation("/usuarios-panel")}
      ...
      <div className="bg-white shadow-lg rounded-lg p-6">
        ...
        <p className="text-gray-600 mb-6">
          Administra y realiza seguimientos de los pedidos personalizados de los
          clientes.
        </p>
        <button
